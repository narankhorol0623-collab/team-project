...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-white/80 dark:bg-[#00000052] backdrop-blur-md  border-black dark:border-black dark:text-white ">
      <nav className="flex items-center justify-between p-6 w-full">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="https://chromewebstore.google.com/detail/bpuzzle-tetris-game/cgjlgmcfhoicddhjikmjglhgibchboea"
